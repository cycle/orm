...
namespace Cycle\ORM\Tests\Relation\RefersTo;
...
abstract class RefersToProxyMapperTest extends BaseTest
{
    use TableTrait;
    ...
    {
        $p = (new Select($this->orm, Profile::class))->wherePK(1)->fetchOne();
