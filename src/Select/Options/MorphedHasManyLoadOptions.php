...
final class MorphedHasManyLoadOptions extends JoinableLoadOptions
{
    public function __construct(
         ...
         * Example:
         *
         *      method: LoadMethod::OuterQuery    // POSTLOAD: separate SELECT (default)
         ...
         *             ->load('comments', new MorphedHasManyLoadOptions(using: 'comment'));
         */
        ?string $using = null,
         ...
         * Example:
         *
         *      where: ['@.status' => 'public']                       // status = 'public'
         *      where: ['@.level' => ['>=' => 3]]                     // level >= 3
