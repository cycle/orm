...
namespace Cycle\ORM\Tests\Functional\Relation\ManyToMany;
...
abstract class ManyToManyScopedPivotTest extends BaseTest
{
    use TableTrait;
    ...
    public function testLoaderRelationWithScope(): void
    {
        $this->orm = $this->withPivotSchema([
